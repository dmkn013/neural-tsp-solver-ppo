...
def parse():
  ...
  parser.add_argument('--n_epochs_policy_only', type=int, default=100)
  parser.add_argument('--n_epochs_reward', type=int, default=100)
  parser.add_argument('--n_epochs_policy_direct', type=int, default=100)
  parser.add_argument('--n_rollout', type=int, default=8)
  parser.add_argument('--lr', default=1.e-4, type=float)
  parser.add_argument('--lr_reward', default=1.e-4, type=float)
  ...
  parser.add_argument('--n_layers_reward', type=int, default=2)
